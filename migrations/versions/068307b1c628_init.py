...
Revision ID: 068307b1c628
Revises: 
Create Date: 2025-08-04 15:50:35.371019
...
def upgrade() -> None:
    ...
    sa.Column('project_id', sa.BigInteger(), nullable=False, comment='项目ID'),
    sa.Column('strategy_id', sa.BigInteger(), nullable=True, comment='策略ID'),
    sa.Column('strategy_instance_id', sa.String(length=200), nullable=True, comment='策略实例ID'),
    sa.Column('position_id', sa.BigInteger(), nullable=True, comment='仓位ID'),
    sa.Column('order_id', sa.BigInteger(), nullable=True, comment='订单ID'),
    sa.Column('signal_id', sa.BigInteger(), nullable=True, comment='信号ID'),
    ...
    sa.Column('position_id', sa.BigInteger(), nullable=True, comment='仓位ID'),
    sa.Column('exec_order_id', sa.BigInteger(), nullable=False, comment='执行订单ID'),
    sa.Column('signal_id', sa.BigInteger(), nullable=False, comment='信号ID'),
    sa.Column('strategy_id', sa.BigInteger(), nullable=False, comment='策略ID'),
    sa.Column('project_id', sa.BigInteger(), nullable=False),
    ...
    sa.Column('executor_id', sa.BigInteger(), nullable=True, comment='执行ID'),
