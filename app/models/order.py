...
class Order(BaseModel):
    ...
    strategy_instance_id = Column('strategy_instant_id', String(200), index=True, nullable=False, comment="策略实例ID")
...
class ExecutionOrder(BaseModel):
    ...
    strategy_instance_id = Column('strategy_instant_id', String(64), nullable=False)
